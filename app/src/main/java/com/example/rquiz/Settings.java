...
public class Settings extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            //Go to home page
            case R.id.nav_home:
                Intent homeIntent = new Intent(Settings.this, Subject.class);
            ...
            case R.id.nav_history:
                Intent historyIntent = new Intent(Settings.this, History.class);
                //Store username data in getUser
            ...
            case R.id.nav_about:
                Intent aboutIntent = new Intent(Settings.this, AboutActivity.class);
                //Store username data in getUser
